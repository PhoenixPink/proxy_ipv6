...
#read COUNT
FIRST_PORT=27085
LAST_PORT=$((($FIRST_PORT-1) + 1))
#LAST_PORT=$((($FIRST_PORT-1) + $COUNT))
...
wget -O /etc/rc.d/rc.local https://raw.githubusercontent.com/PhoenixPink/proxy_ipv6/main/rc-reg.local && chmod +x /etc/rc.d/rc-reg.local
